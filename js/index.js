...
judge = function() {
   ...
   */
  var cellNum, colors, conds, j, numCommodity, numEquip, numMimic, numMimicMax, numMimicMin, numMoney, numNotMimic, nums, patterns, ref, ref1, stockedIndexes, validPattern, validPatternOnlyMimicResearch, x, y;
  x = getX();
  y = getY();
  cellNum = getCellNum();
  ...
  // 確定をのぞいてさらに探索
  patterns = [];
  for (numMimic = j = ref = numMimicMin, ref1 = numMimicMax; (ref <= ref1 ? j <= ref1 : j >= ref1); numMimic = ref <= ref1 ? ++j : --j) {
...
getValidPattern = function(conds, colors, stockedIndexes, patterns, nums) {
